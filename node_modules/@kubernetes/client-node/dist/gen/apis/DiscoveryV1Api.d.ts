...
export declare class DiscoveryV1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    createNamespacedEndpointSlice(namespace: string, body: V1EndpointSlice, pretty?: string, dryRun?: string, fieldManager?: string, fieldValidation?: string, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     * @param body
     */
    deleteCollectionNamespacedEndpointSlice(namespace: string, pretty?: string, _continue?: string, dryRun?: string, fieldSelector?: string, gracePeriodSeconds?: number, labelSelector?: string, limit?: number, orphanDependents?: boolean, propagationPolicy?: string, resourceVersion?: string, resourceVersionMatch?: string, sendInitialEvents?: boolean, timeoutSeconds?: number, body?: V1DeleteOptions, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     */
    patchNamespacedEndpointSlice(name: string, namespace: string, body: any, pretty?: string, dryRun?: string, fieldManager?: string, fieldValidation?: string, force?: boolean, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     * @param fieldValidation fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered.
     */
    replaceNamespacedEndpointSlice(name: string, namespace: string, body: V1EndpointSlice, pretty?: string, dryRun?: string, fieldManager?: string, fieldValidation?: string, _options?: Configuration): Promise<RequestContext>;
}
export declare class DiscoveryV1ApiResponseProcessor {
     ...
     */
    createNamespacedEndpointSliceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1EndpointSlice>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listEndpointSliceForAllNamespacesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1EndpointSliceList>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    listNamespacedEndpointSliceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1EndpointSliceList>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    patchNamespacedEndpointSliceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1EndpointSlice>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    readNamespacedEndpointSliceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1EndpointSlice>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
    replaceNamespacedEndpointSliceWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1EndpointSlice>>;
}
