...
export declare class AuthenticationV1ApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    createSelfSubjectReview(body: V1SelfSubjectReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, _options?: Configuration): Promise<RequestContext>;
    /**
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    createTokenReview(body: V1TokenReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, _options?: Configuration): Promise<RequestContext>;
    /**
...
export declare class AuthenticationV1ApiResponseProcessor {
     ...
     */
    createSelfSubjectReviewWithHttpInfo(response: ResponseContext): Promise<HttpInfo<V1SelfSubjectReview>>;
    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
