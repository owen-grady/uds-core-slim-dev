...
class AuthenticationV1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    async createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty, _options) {
        ...
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("AuthenticationV1Api", "createSelfSubjectReview", "body");
        }
        // Path Params
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1SelfSubjectReview", ""), contentType);
...
class AuthenticationV1ApiResponseProcessor {
    ...
    async createSelfSubjectReviewWithHttpInfo(response) {
        ...
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1SelfSubjectReview", "");
