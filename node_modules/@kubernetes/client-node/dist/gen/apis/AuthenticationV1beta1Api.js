...
exports.AuthenticationV1beta1ApiResponseProcessor = exports.AuthenticationV1beta1ApiRequestFactory = void 0;
 ...
 * no description
 */
class AuthenticationV1beta1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
    ...
    async createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty, _options) {
        ...
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("AuthenticationV1beta1Api", "createSelfSubjectReview", "body");
        }
        // Path Params
        const localVarPath = '/apis/authentication.k8s.io/v1beta1/selfsubjectreviews';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1beta1SelfSubjectReview", ""), contentType);
...
exports.AuthenticationV1beta1ApiRequestFactory = AuthenticationV1beta1ApiRequestFactory;
class AuthenticationV1beta1ApiResponseProcessor {
    /**
    ...
    async createSelfSubjectReviewWithHttpInfo(response) {
        ...
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1beta1SelfSubjectReview", "");
...
exports.AuthenticationV1beta1ApiResponseProcessor = AuthenticationV1beta1ApiResponseProcessor;
