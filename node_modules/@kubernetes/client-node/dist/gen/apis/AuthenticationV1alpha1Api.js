...
exports.AuthenticationV1alpha1ApiResponseProcessor = exports.AuthenticationV1alpha1ApiRequestFactory = void 0;
 ...
 * no description
 */
class AuthenticationV1alpha1ApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    /**
    ...
    async createSelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty, _options) {
        ...
        if (body === null || body === undefined) {
            throw new baseapi_1.RequiredError("AuthenticationV1alpha1Api", "createSelfSubjectReview", "body");
        }
        // Path Params
        const localVarPath = '/apis/authentication.k8s.io/v1alpha1/selfsubjectreviews';
        ...
        const serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(body, "V1alpha1SelfSubjectReview", ""), contentType);
    ...
    async getAPIResources(_options) {
        ...
        let _config = _options || this.configuration;
        // Path Params
        const localVarPath = '/apis/authentication.k8s.io/v1alpha1/';
        // Make Request Context
...
exports.AuthenticationV1alpha1ApiRequestFactory = AuthenticationV1alpha1ApiRequestFactory;
class AuthenticationV1alpha1ApiResponseProcessor {
    /**
    ...
    async createSelfSubjectReviewWithHttpInfo(response) {
        ...
        if ((0, util_1.isCodeInRange)("200", response.httpStatusCode)) {
            const body = ObjectSerializer_1.ObjectSerializer.deserialize(ObjectSerializer_1.ObjectSerializer.parse(await response.body.text(), contentType), "V1alpha1SelfSubjectReview", "");
...
exports.AuthenticationV1alpha1ApiResponseProcessor = AuthenticationV1alpha1ApiResponseProcessor;
