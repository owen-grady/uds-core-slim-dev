...
export declare function AddOptionsToSearchParams(options: LogOptions | undefined, searchParams: URLSearchParams): URLSearchParams | undefined;
export declare class Log {
    config: KubeConfig;
    constructor(config: KubeConfig);
    log(namespace: string, podName: string, containerName: string, stream: Writable, options?: LogOptions): Promise<AbortController>;
    /** @deprecated done callback is deprecated */
    log(namespace: string, podName: string, containerName: string, stream: Writable, done: (err: any) => void, options?: LogOptions): Promise<AbortController>;
}
